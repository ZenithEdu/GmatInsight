            ...
            <div className="group">
              <div className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100 overflow-hidden">
                ...
                <div className="bg-gradient-to-r from-blue-500 to-indigo-600 p-5 text-white">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <h3 className="text-xl font-bold">Assessment Vault</h3>
                        <p className="text-blue-100 text-sm">Evaluation tools</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-5">
                  ...
                  <button
                    onClick={() => navigate('/assessment-vault')}
                  ...
                  >
                    ...
                    <span>Enter Assessment Vault</span>
