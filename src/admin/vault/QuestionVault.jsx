...
export default function QuestionVault() {
  ...
  return (
    <>
      <AdminHeader />
      <div className="min-h-[calc(100vh-6rem)] bg-gradient-to-br from-slate-50 to-blue-50 flex flex-col">
        <main className="flex-grow px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="max-w-7xl mx-auto">
            <div className="mb-8 text-center">
              <h1 className="text-3xl font-bold text-gray-900 mb-2">Question Vault</h1>
